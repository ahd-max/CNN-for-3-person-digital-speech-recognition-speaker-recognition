# -*- coding: utf-8 -*-
"""
Created on Sat Oct 29 17:16:00 2022

@author: Hangdong AN
"""
if __name__ == '__main__':
    import load1
    from dp_refined1 import Network

    train_samples, train_labels = load1._train_samples, load1._train_labels
    test_samples, test_labels = load1._test_samples, load1._test_labels

    print('Training set', train_samples.shape, train_labels.shape)
    print('    Test set', test_samples.shape, test_labels.shape)

    image_size = load1.image_size
    num_labels = load1.num_labels
    num_channels = load1.num_channels
